...
import ndcsp from "../assets/portfolio/ndscp.PNG";

const Portfolio = () => {
  return (
    <div className="w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white py-8">
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          ...
          <div className="shadow-md shadow-gray-600 rounded-lg bg-gradient-to-b from-gray-800 to-black">
            <img
              src={ndcsp}
              alt="NDCSP: Alumni Tracking System"
              className="rounded-md duration-200 hover:scale-105"
            />
            <div className="flex items-center justify-center">
              <button className="w-full px-6 py-3 m-4 duration-200 hover:scale-105 text-white">
                NDCSP: Alumni Tracking System
              </button>
            </div>
          </div>
        </div>
